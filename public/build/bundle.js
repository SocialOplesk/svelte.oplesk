...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h3 = element("h3");
    			h3.textContent = "...";
    			add_location(h3, file$4, 17, 4, 350);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h3 = element("h3");
    			h3.textContent = "welcome to de app";
    			add_location(h3, file$4, 15, 4, 305);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*$store*/ ctx[0]) return create_if_block$2;
    	...
    	const block = {
    		c: function create() {
    			...
    			button1.textContent = "redirect";
    			add_location(h1, file$4, 12, 3, 233);
    			add_location(h2, file$4, 13, 3, 256);
    			add_location(button0, file$4, 20, 3, 379);
    			add_location(button1, file$4, 21, 3, 436);
    			add_location(div, file$4, 11, 0, 223);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$store*/ 1) set_data_dev(t3, /*$store*/ ctx[0]);
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => doLogin(true);
    	const click_handler_1 = () => doRedirect();
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("doRedirect" in $$props) $$invalidate(1, doRedirect = $$props.doRedirect);
    	};
    	...
    	return [$store, doRedirect, click_handler, click_handler_1];
    }
    ...
    /* src\Users.svelte generated by Svelte v3.38.2 */

    const { console: console_1 } = globals;
    const file$3 = "src\\Users.svelte";
    ...
    function create_catch_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "catch",
    		source: "(1:0) <script>     import {useNavigate}",
    		ctx
    	});
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			t2 = text(/*pass*/ ctx[1]);
    			add_location(div0, file$3, 39, 6, 1017);
    			add_location(div1, file$3, 40, 6, 1043);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div0, anchor);
    			append_dev(div0, t0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*email*/ 1) set_data_dev(t0, /*email*/ ctx[0]);
    			if (dirty & /*pass*/ 2) set_data_dev(t2, /*pass*/ ctx[1]);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div0);
    			if (detaching) detach_dev(t1);
    ...
    function create_fragment$3(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*$store*/ ctx[2] && create_if_block$1(ctx);

    	const block = {
    		c: function create() {
    			div = element("div");
    			h10 = element("h1");
    			h10.textContent = "welcome to test";
    			t1 = space();
    			h11 = element("h1");
    			t2 = text("islogin: ");
    			t3 = text(/*$store*/ ctx[2]);
    			...
    			t6 = space();
    			if (if_block) if_block.c();
    			add_location(h10, file$3, 34, 4, 843);
    			add_location(h11, file$3, 35, 4, 873);
    			add_location(button, file$3, 36, 4, 905);
    			add_location(div, file$3, 33, 0, 832);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$store*/ 4) set_data_dev(t3, /*$store*/ ctx[2]);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let fetchData = (async () => {
    		try {
    			...
    			$$invalidate(0, email = res.data.email);
    			$$invalidate(1, pass = res.data.pass);
    		} catch(err) {
    			console.log(err);
    		}
    	})();
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Users> was created with unknown prop '${key}'`);
    	});

    	const click_handler = () => doLogout();
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("doLogout" in $$props) $$invalidate(3, doLogout = $$props.doLogout);
    	...
    	return [email, pass, $store, doLogout, fetchData, click_handler];
    }
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h2 = element("h2");
    			h2.textContent = "now view contact this enable";
    			add_location(h2, file$2, 9, 5, 155);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*$store*/ ctx[0] && create_if_block(ctx);

    	const block = {
    		c: function create() {
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = "Iam Contact";
    			t1 = space();
    			h2 = element("h2");
    			t2 = text("isLogin ");
    			t3 = text(/*$store*/ ctx[0]);
    			...
    			add_location(h1, file$2, 6, 4, 79);
    			add_location(h2, file$2, 7, 4, 105);
    			add_location(button, file$2, 11, 4, 209);
    			add_location(div, file$2, 5, 0, 68);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => doLogin(false);
    	$$self.$capture_state = () => ({ store, doLogin, $store });
    ...
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(18:4) <Route path='contact'>",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(nav, file$1, 9, 4, 225);
    		},
    		m: function mount(target, anchor) {
